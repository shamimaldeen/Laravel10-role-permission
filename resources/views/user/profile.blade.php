            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('Update User Profile')}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{trans('UserName')}} *</strong> </label>
                                ...
                                <div class="form-group">
                                    <label>{{trans('Phone Number')}} *</strong> </label>
