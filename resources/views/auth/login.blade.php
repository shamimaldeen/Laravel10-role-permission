          ...
          <div class="form-inner">
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
              ...
              <div class="form-group-material">
                ...
                <label for="login-username" class="label-material">{{trans('UserName')}}</label>
                @if ($errors->has('name'))
                    <p>
              ...
              <div class="form-group-material">
                ...
                <label for="login-password" class="label-material">{{trans('Password')}}</label>
                @if ($errors->has('name'))
                    <p>
                        <strong>{{ $errors->first('name') }}</strong>
                    </p>
            ...
            <br><br> -->
            <!-- <a href="{{ route('password.request') }}" class="forgot-pass">{{trans('Forgot Password?')}}</a> -->
            <!-- <p>{{trans('Do not have an account?')}}</p><a href="{{url('register')}}" class="signup">{{trans('Register')}}</a> -->
          </div>
          <div class="copyrights text-center">
            <p>{{trans('Developed By')}} <span class="external">{{$general_setting->developed_by}}</span></p>
          </div>
        </div>
      </div>
    </div>
