          ...
          <div class="form-inner">
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group-material">
                ...
                <label for="register-username" class="label-material">{{trans('UserName')}} *</label>
                @if ($errors->has('name'))
                    <p>
              ...
              <div class="form-group-material">
                ...
                <label for="register-email" class="label-material">{{trans('Email')}} *</label>
                @if ($errors->has('email'))
                    <p>
              ...
              <div class="form-group-material">
                ...
                <label for="register-phone" class="label-material">{{trans('Phone Number')}} *</label>
              </div>
              <div class="form-group-material">
                <input id="register-company" type="text" name="company_name" class="input-material">
                <label for="register-company" class="label-material">{{trans('Company Name')}}</label>
              </div>
              <div class="form-group-material">
              ...
              <div id="customer-section">
                  <div class="form-group-material">
                    ...
                    <label for="customer-name" class="label-material">{{trans('name')}} *</label>
                  </div>
                  <div class="form-group-material">
                  ...
                  <div class="form-group-material">
                    ...
                    <label for="customer-tax-number" class="label-material">{{trans('Tax Number')}}</label>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-address" type="text" name="address" class="input-material customer-field">
                    <label for="customer-address" class="label-material">{{trans('Address')}} *</label>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-city" type="text" name="city" class="input-material customer-field">
                    <label for="customer-city" class="label-material">{{trans('City')}} *</label>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-state" type="text" name="state" class="input-material">
                    <label for="customer-state" class="label-material">{{trans('State')}}</label>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-postal" type="text" name="postal_code" class="input-material">
                    <label for="customer-postal" class="label-material">{{trans('Postal Code')}}</label>
                  </div>
                  <div class="form-group-material">
                    <input id="customer-country" type="text" name="country" class="input-material">
                    <label for="customer-country" class="label-material">{{trans('Country')}}</label>
                  </div>
              </div>
              ...
              <div class="form-group-material">
                ...
                <label for="passowrd" class="label-material">{{trans('Password')}} *</label>
              ...
              <div class="form-group-material">
                ...
                <label for="password-confirm" class="label-material">{{trans('Confirm Password')}} *</label>
              </div>
              <input id="register" type="submit" value="Register" class="btn btn-primary">
            </form><p>{{trans('Already have an account')}}? </p><a href="{{url('login')}}" class="signup">{{trans('LogIn')}}</a>
          </div>
        </div>
      </div>
    </div>
